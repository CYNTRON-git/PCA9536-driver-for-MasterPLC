...
// Event priority config — unicast [addr] 46 18 05 [type] [reg_h] [reg_l] [count] [prio] CRC (11 bytes)
...
// Serial-addressed inner-PDU wrapper — FD 46 08 [serial BE 4B] [inner_pdu] CRC
...
//   Returns  1 — events received (0x11 FMB_SUB_EVT_TRANSMIT); events vector populated.
//   Returns  0 — no events (0x12 FMB_SUB_EVT_NONE); bus quiet.
//   Returns -1 — frame error (CRC, unexpected subcommand, length).
