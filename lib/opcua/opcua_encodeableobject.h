...
OPCUA_EXPORT OpcUa_StatusCode OpcUa_EncodeableObjectGeneric_GetSize( OpcUa_Void*            pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32*           pSize);
OPCUA_EXPORT OpcUa_StatusCode  OpcUa_EncodeableObjectGeneric_Encode( OpcUa_Void*            pValue, struct _OpcUa_Encoder* pEncoder);
OPCUA_EXPORT OpcUa_StatusCode  OpcUa_EncodeableObjectGeneric_Decode( OpcUa_Void*            pValue, struct _OpcUa_Decoder* pDecoder);

// InSAT код перенесен из opcua_encodableobject.c
