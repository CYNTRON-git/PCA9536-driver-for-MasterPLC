...
// InSAT взято из пред версии.  В версии 1.04 отсутствует
#define OPCUA_TRACE_OUTPUT_FILE			0x00001000
#define OPCUA_TRACE_OUTPUT_CONSOLE		0x00001001
#define OPCUA_TRACE_OUTPUT_NONE			0x00001002
// End InSAT взято из пред версии.  В версии 1.04 отсутствует

/* predefined trace levels */
// InSAT Взято из пред версии. В 1.04 нет
#define OPCUA_TRACE_LEVEL_ALWAYS        0x00000040 /* Always code. permet de toujours afficher un message 2^6*/
...
#define OPCUA_TRACE_OUTPUT_LEVEL_ERROR   (OPCUA_TRACE_LEVEL_ERROR | OPCUA_TRACE_LEVEL_SYSTEM)
...
OPCUA_EXPORT OpcUa_StatusCode OPCUA_DLLCALL OpcUa_Trace_Initialize(OpcUa_Int32 iTraceLevel,
                                                                   OpcUa_Int32 iTraceOutput,
                                                                   OpcUa_String TraceFileName,
                                                                   FILE** hTraceFile);
...
#endif
OPCUA_EXPORT PRINTF_ATTR(4, 5) OpcUa_Boolean OPCUA_DLLCALL OpcUa_Trace_Imp(
    OpcUa_UInt32 uTraceLevel,
#if OPCUA_TRACE_FILE_LINE_INFO
    const OpcUa_CharA* sFile,
    OpcUa_UInt32 sLine,
#endif /* OPCUA_TRACE_FILE_LINE_INFO */
    _Printf_format_string_ const OpcUa_CharA* sFormat,
    ...)
#if OPCUA_TRACE_FILE_LINE_INFO
OPCUA_PRINTF_ARGS(4)
#else
...
#define OpcUa_Trace_Raw OpcUa_Trace
