...
#include "opcua_pki.h"
#include "platforms/opcua_p_interface.h"
...
// InSAT код взят из старой версии. В 1.04 отсутствовал
typedef OpcUa_Boolean(*OpcUa_TraceFunc)(OpcUa_CharA* a_sMessage);

// End InSAT код взят из старой версии. В 1.04 отсутствовал
...
// InSAT код ниже взят из старой версии. В 1.04 отсутствовал
	/* Trace_FileName */
	OpcUa_String	StrProxyStub_Trace_FileName; // "OpenOpcUaStack.log"
	/* configure the output for the trace FILE, CONSOLE or NONE */
	OpcUa_UInt32	uProxyStub_Trace_Output;

	OpcUa_UInt32	hOutFileNoOfEntriesMax; // Number max of entries to bufferize before write to trace file
	OpcUa_UInt32	hOutFileNoOfEntries; // Current number of entries in the buffer
	FILE*			hProxyStub_OutFile; // Handle for the trace file

	OpcUa_TraceFunc pProxyStub_Trace_Func; //InSAT
