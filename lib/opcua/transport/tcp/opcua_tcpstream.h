...
// InSAT ReverseHello как пределено в OPC UA 1.04
#define OPCUA_TCPSTREAM_SIGNATURE_REVERSEHELLO  "RHEF"
...
enum _OpcUa_TcpStream_MessageType
{
    ...
    // InSAT ReverseHello как пределено в OPC UA 1.04
    /** @brief Establishes a new connection with the client. This message is only sent by the server. */
    OpcUa_TcpStream_MessageType_ReverseHello,
