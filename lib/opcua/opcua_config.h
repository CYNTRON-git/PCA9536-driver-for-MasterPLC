...
// InSAT Все платформы используют unsafe версии как в пред версии
...
/** @brief Enable output to trace device. */
#define OPCUA_TRACE_MAXLENGTH                       10000


// 10.04.2015 InSAT Вернулись к изначальным настройкам 
// InSAT Ниже новый код
...
// Изменено на 30 мин. по причине разрыва соединения при длительном таймауте в режиме чтения
// см. Bug 27835: OPC UA не изменяется метка времени
// #define OPCUA_TCPLISTENER_TIMEOUT 600000
#define OPCUA_TCPLISTENER_TIMEOUT                   1800000
...
//InSAT
// Внимание!!! Пока выключать при чекине
// Для подключения кода alarm and events
//#define OPC_UA_AE
