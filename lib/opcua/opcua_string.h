 ...
 */
OPCUA_EXPORT
OpcUa_StatusCode OpcUa_String_StrCpy(/* bi */ OpcUa_String* pDestString,
...
/** 
 * @brief Convert a Unicode string to a single byte string.
 *
 * The destination string could be allocated or not with OpcUa_Alloc. The destination string must be freed after usage.
 *
 * @param aStrOut [out] The single byte string destination.
 * @param wStrIn [in]  The unicode string being converted.
 *
 * @return Status code; @see opcua_statuscodes.h
 */

OPCUA_EXPORT 
OpcUa_StatusCode OpcUa_String_WtoA( OpcUa_Char* wStrIn, OpcUa_CharA** aStrOut);

/** 
 * @brief Convert a single byte string to a Unicode string.
 *
 * The destination string could be allocated or not with OpcUa_Alloc. The destination string must be freed after usage.
 *
 * @param wStrOut [out] The unicode string destination.
 * @param aStrIn [in]  The single byte string being converted.
 *
 * @return Status code; @see opcua_statuscodes.h
 */

OPCUA_EXPORT OpcUa_StatusCode OpcUa_String_AtoW( const OpcUa_CharA* aStrIn, wchar_t** wStrOut);
