...
inline void zone::swap(zone& o) noexcept {
    m_chunk_size = o.m_chunk_size;
    m_chunk_list = o.m_chunk_list;
    o.m_chunk_list = nullptr;
    m_finalizer_array = std::move(o.m_finalizer_array);
    //std::swap(*this, o);
}
